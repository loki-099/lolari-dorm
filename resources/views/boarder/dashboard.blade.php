...
@section('content')
    @if ($rent_data)
        <div class="p-4 border-1 border-default border-dashed rounded-base min-h-screen">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
                {{-- Rent Details --}}
                <div class="bg-neutral-primary-soft block p-6 border border-default rounded-base shadow-md md:col-span-3">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-x-4 gap-y-4">
                        <span class="flex items-center gap-x-2">
                            ...
                            <div>
                                <p class="text-xs text-green-500 dark:text-green-400">Billing Period</p>
                        ...
                        <span class="flex items-center gap-x-2">
                            ...
                            <div>
                                <p class="text-red-500 dark:text-red-400 text-xs">Due Date:</p>
                ...
                {{-- Room Details --}}
                <div class="bg-neutral-primary-soft block p-6 border border-default rounded-base shadow-md md:col-span-2">
            ...
            <div class="grid md:grid-cols-3 gap-4 mb-4">
                {{-- Electric Bill --}}
                <div class="bg-neutral-primary-soft p-6 border border-default rounded-base shadow-md min-h-24">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                {{-- Water Bill --}}
                <div class="bg-neutral-primary-soft block p-6 border border-default rounded-base shadow-md min-h-24">
                    <div class="flex items-center justify-between">
                        <div>
    ...
    @else
        <div class="p-4 border-1 border-default border-dashed rounded-base min-h-screen">
            <p class="text-center text-fg-disabled">No room assignment found.</p>
        </div>
    @endif
@endsection
