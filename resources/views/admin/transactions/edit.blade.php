...
<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    <!-- Card Header -->
    <div class="mb-6">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Transaction</h3>
        <p class="text-gray-500 dark:text-gray-400 mt-1">Update the transaction details below</p>
    </div>
    ...
    <form action="{{ route('admin.transactions.update', $transaction) }}" method="POST" class="space-y-6" id="transactionForm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" id="amount" name="amount" value="{{ old('amount', $transaction->amount) }}" step="0.01" min="0.01"
        ...
        <div>
            ...
            <input type="date" id="billing_month" name="billing_month" value="{{ old('billing_month', $transaction->billing_month) }}" 
        ...
        <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
            <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-3">Transaction Information</h4>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                    <span class="text-gray-500 dark:text-gray-400">Transaction ID:</span>
                    <span class="text-gray-900 dark:text-white font-medium ml-2">#{{ $transaction->id }}</span>
                </div>
                <div>
                    <span class="text-gray-500 dark:text-gray-400">Created:</span>
                    <span class="text-gray-900 dark:text-white font-medium ml-2">{{ $transaction->created_at->format('M d, Y h:i A') }}</span>
                </div>
