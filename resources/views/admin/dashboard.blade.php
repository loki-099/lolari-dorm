...
<div class="px-4 pt-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="p-5 bg-white border border-gray-200 rounded-xl shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.rooms.index') }}" class="inline-flex items-center gap-1 text-xs font-medium text-amber-600 hover:underline dark:text-amber-500">
                    View rooms
                ...
                <table class="min-w-full text-sm">
                    <thead>
                        <tr class="border-b border-gray-200 dark:border-gray-700">
                            <th class="pb-2 text-left text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 pr-3">Boarder</th>
                            <th class="pb-2 text-left text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 pr-3">Room</th>
                            <th class="pb-2 text-left text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 pr-3">Amount</th>
                            <th class="pb-2 text-left text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 pr-3">Status</th>
