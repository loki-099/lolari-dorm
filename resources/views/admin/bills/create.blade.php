...
<div class="space-y-6">
    ...
    <!-- Form -->
    <form action="{{ route('admin.bills.store') }}" method="POST" class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
        @csrf
