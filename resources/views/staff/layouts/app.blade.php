    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: true }">
        ...
        <aside class="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 shadow-sm flex flex-col fixed h-screen z-40 lg:translate-x-0 transition-transform duration-300"
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('staff.reports.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                ...
                <div class="px-4 md:px-6 py-4 flex items-center justify-between">
                    ...
                    <button id="theme-toggle" class="inline-flex items-center justify-center w-10 h-10 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
                        ...
                        <svg id="theme-toggle-light-icon" class="w-5 h-5 hidden dark:block" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l-1.414-1.414a2 2 0 10-2.828 0l-1.414 1.414a1 1 0 101.414 1.414l1-1a2 2 0 012.828 0l1 1a1 1 0 101.414-1.414zM3 10a1 1 0 01-1-1V7a1 1 0 012 0v2a1 1 0 01-1 1zm14 0a1 1 0 011-1v-2a1 1 0 11-2 0v2a1 1 0 011 1zm0 3a1 1 0 01-1-1v-2a1 1 0 112 0v2a1 1 0 01-1 1z" clip-rule="evenodd"></path>
                        </svg>
