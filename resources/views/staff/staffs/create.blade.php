...
<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    <!-- Card Header -->
    <div class="mb-6">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Register New Staff</h3>
        <p class="text-gray-500 dark:text-gray-400 mt-1">Fill in the staff member's personal information below</p>
        <p class="text-sm text-blue-600 dark:text-blue-400 mt-1">Default password: <code>staff123</code></p>
    </div>

    <form action="{{ route('staff.staffs.store') }}" method="POST" class="space-y-6" id="staffForm">
        @csrf
...
<script>
    document.getElementById('staffForm').addEventListener('submit', function(e) {
        ...
        submitBtn.innerHTML = '<svg class="animate-spin -ml-1 mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path fill="none" stroke="currentColor" stroke-width="4" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path></svg>Creating...';
    });
</script>
@endsection
