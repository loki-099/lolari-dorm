...
<div class="p-6 space-y-6">
    ...
    <form action="{{ route('staff.transactions.update', $transaction) }}" method="POST" class="space-y-6" id="transactionForm">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <select id="payment_method" name="payment_method" required
                    ...
                    <option value="online" {{ old('payment_method', $transaction->payment_method) == 'online' ? 'selected' : '' }}>E-wallet</option>
                </select>
