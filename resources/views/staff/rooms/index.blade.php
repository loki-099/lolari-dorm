                        ...
                        <tr class="bg-white transition-colors hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('staff.rooms.show', $room) }}" class="font-medium text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">View</a>
                                    <a href="{{ route('staff.rooms.edit', $room) }}" class="font-medium text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300">Edit</a>
                                </div>
                            </td>
                        </tr>
                    @empty
