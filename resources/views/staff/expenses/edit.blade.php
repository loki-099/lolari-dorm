...
<div class="p-6 space-y-6">
    ...
    <form action="{{ route('staff.expenses.update', $expense) }}" method="POST" class="space-y-6" id="expenseForm">
        @csrf
        @method('PUT')
