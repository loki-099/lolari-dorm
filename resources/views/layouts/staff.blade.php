...
<body class="dark:bg-dark-backdrop">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="{{ route('staff.dashboard') }}" class="flex ms-2 md:me-24">
                        <span class="self-center text-lg font-semibold whitespace-nowrap dark:text-white">Staff
                            Dashboard</span>
                    </a>
                </div>
    ...
    <aside id="top-bar-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
            <a href="{{ route('staff.dashboard') }}" class="flex items-center ps-2.5 mb-5">
            ...
            <ul class="space-y-2 font-medium pt-4">
                ...
                <li>
                    <a href="{{ route('staff.reports.index') }}"
                        ...
                        <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-fg-brand"
                            ...
                            fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="M4 4h16v4H4V4Zm0 6h16v4H4v-4Zm0 6h16v4H4v-4Z" />
                        </svg>
                ...
                <li>
                    <a href="{{ route('staff.bills.index') }}"
                        class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-fg-brand"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            fill="none" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="{{ route('staff.activity.index') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Boarder Activities</span>
                    </a>
                </li>
            </ul>
        </div>
