...
class BillController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('staff.bills.index', compact('bills', 'rooms'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.bills.create', compact('rooms'));
    }
    ...
    public function show(UtilityBill $bill)
    {
        ...
        return view('staff.bills.show', compact('bill'));
    }
    ...
    public function edit(UtilityBill $bill)
    {
        ...
        return view('staff.bills.edit', compact('bill', 'rooms'));
    }
